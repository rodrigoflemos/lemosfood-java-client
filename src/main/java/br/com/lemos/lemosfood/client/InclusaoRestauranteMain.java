package br.com.lemos.lemosfood.client;

import java.math.BigDecimal;

import org.springframework.web.client.RestTemplate;

import br.com.lemos.lemosfood.client.api.ClientApiException;
import br.com.lemos.lemosfood.client.api.RestauranteClient;
import br.com.lemos.lemosfood.client.model.RestauranteModel;
import br.com.lemos.lemosfood.client.model.input.CidadeIdInput;
import br.com.lemos.lemosfood.client.model.input.CozinhaIdInput;
import br.com.lemos.lemosfood.client.model.input.EnderecoInput;
import br.com.lemos.lemosfood.client.model.input.RestauranteInput;
	  ...
	  public static void main(String[] args) {
	    try {
	      ...
	      var restauranteClient = new RestauranteClient(
	          restTemplate, "http://api.sgm.local:8080");
	      ...
	      if (e.getProblem() != null) {
	        ...
	        if(e.getProblem().getObjects() != null) {
